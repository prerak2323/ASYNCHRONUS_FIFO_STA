...
show -format svg -prefix syncA wptr_handler  # Specify top module here

# Write the final Verilog netlist without attributes, expressions, hexadecimal, or decimal
write_verilog -noattr -noexpr -nohex -nodec wptr_handler_netlist.v
